Map_obj83:	mappingsTable offset(*)
...
Map_obj83_0008:	spriteHeader offset(*)
	spritePiece	-$20, -8, 4, 2, $55, 0, 0, 3, 0
	spritePiece	0, -8, 4, 2, $55, 0, 0, 3, 0
	spriteFooter offset(*)

Map_obj83_001A:	spriteHeader offset(*)
	spritePiece	-8, -8, 2, 2, $51, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj83_0024:	spriteHeader offset(*)
	spritePiece	-$10, -$10, 4, 3, $45, 0, 0, 2, 0
	spritePiece	-8, -8, 2, 2, $51, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj83_0036:	spriteHeader offset(*)
	spriteFooter offset(*)
