Map_obj54:	mappingsTable offset(*)
...
Map_obj54_002A:	spriteHeader offset(*)
	spritePiece	$1C, 0, 2, 2, $1E4, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj54_0034:	spriteHeader offset(*)
	spritePiece	$1C, 0, 2, 2, $1E8, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj54_003E:	spriteHeader offset(*)
...
Map_obj54_0068:	spriteHeader offset(*)
	spritePiece	-$C, -$C, 3, 3, $E, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj54_0072:	spriteHeader offset(*)
	spritePiece	-$C, -$C, 3, 3, $6F, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj54_007C:	spriteHeader offset(*)
	spritePiece	-8, -8, 2, 2, $78, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj54_0086:	spriteHeader offset(*)
	spritePiece	-8, -$C, 2, 3, $17, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj54_0090:	spriteHeader offset(*)
	spritePiece	-$C, -8, 3, 2, $1D, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj54_009A:	spriteHeader offset(*)
	spritePiece	-8, -$C, 2, 3, $23, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj54_00A4:	spriteHeader offset(*)
	spritePiece	-$C, -$C, 3, 3, $29, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj54_00AE:	spriteHeader offset(*)
	spritePiece	-$10, -$10, 4, 4, $32, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj54_00B8:	spriteHeader offset(*)
