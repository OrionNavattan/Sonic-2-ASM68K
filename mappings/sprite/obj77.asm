Map_obj77:	mappingsTable offset(*)
...
Map_obj77_000A:	spriteHeader offset(*)
...
Map_obj77_004C:	spriteHeader offset(*)
	spritePiece	-$40, -8, 2, 2, 0, 0, 0, 0, 0
...
Map_obj77_008E:	spriteHeader offset(*)
	spritePiece	-$40, -8, 2, 2, 0, 0, 0, 0, 0
...
Map_obj77_00D0:	spriteHeader offset(*)
	spritePiece	-$40, -8, 2, 2, 0, 0, 0, 0, 0
...
Map_obj77_0112:	spriteHeader offset(*)
	spritePiece	-$40, -8, 2, 2, 0, 0, 0, 0, 0
	spritePiece	-$40, 8, 2, 2, 0, 0, 0, 0, 0
