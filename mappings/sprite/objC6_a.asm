Map_objC6_a:	mappingsTable offset(*)
...
Map_objC6_a_006E:	spriteHeader offset(*)
	spritePiece	-$20, -$14, 2, 1, $518, 0, 0, 0, 0
	spritePiece	-$10, -$1C, 4, 2, $51A, 0, 0, 0, 0
...
Map_objC6_a_0090:	spriteHeader offset(*)
	spritePiece	-$20, -$14, 2, 1, $518, 0, 0, 0, 0
...
Map_objC6_a_00B2:	spriteHeader offset(*)
	spritePiece	-8, -4, 2, 1, $562, 0, 0, 0, 0
	spriteFooter offset(*)

Map_objC6_a_00BC:	spriteHeader offset(*)
	spritePiece	-$10, -$1A, 4, 2, $508, 0, 0, 0, 0
	spritePiece	-$10, -$A, 4, 3, $564, 0, 0, 0, 0
	spritePiece	-$10, $E, 4, 2, $570, 0, 0, 0, 0
	spriteFooter offset(*)

Map_objC6_a_00D6:	spriteHeader offset(*)
