Map_obj93:	mappingsTable offset(*)
...
Map_obj93_000A:	spriteHeader offset(*)
	spritePiece	-$C, 8, 3, 2, $520, 0, 0, 0, 0
	spritePiece	-8, -$18, 2, 4, $52C, 0, 0, 1, 0
	spritePiece	-8, 0, 2, 2, $3DE, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj93_0024:	spriteHeader offset(*)
	spritePiece	-$C, 8, 3, 2, $526, 0, 0, 0, 0
	spritePiece	-8, -$18, 2, 4, $52C, 0, 0, 1, 0
	spritePiece	-8, 0, 2, 2, $3DE, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj93_003E:	spriteHeader offset(*)
	spritePiece	-$C, 8, 3, 2, $520, 0, 0, 0, 0
	spritePiece	-8, 0, 2, 2, $3DE, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj93_0050:	spriteHeader offset(*)
	spritePiece	-$C, 8, 3, 2, $526, 0, 0, 0, 0
	spritePiece	-8, 0, 2, 2, $3DE, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj93_0062:	spriteHeader offset(*)
