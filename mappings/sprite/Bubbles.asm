...
Frame_Bubble_0:	spritemap
		piece	-4, -4, 1, 1, $8D, 0, 0, 0, 0
		endsprite

Frame_Bubble_1:	spritemap
		piece	-4, -4, 1, 1, $8E, 0, 0, 0, 0
		endsprite

Frame_Bubble_2:	spritemap
		piece	-8, -8, 2, 2, $8F, 0, 0, 0, 0
		endsprite

Frame_Bubble_3:	spritemap
		piece	-8, -8, 2, 2, $93, 0, 0, 0, 0
		endsprite

Frame_Bubble_4:	spritemap
		piece	-$C, -$C, 3, 3, $1C, 0, 0, 0, 0
		endsprite

Frame_Bubble_Full:	spritemap
		piece	-$10, -$10, 4, 4, 8, 0, 0, 0, 0
		endsprite

Frame_Bubble_Burst:	spritemap
		piece	-$10, -$10, 2, 2, $18, 0, 0, 0, 0
		piece	0, -$10, 2, 2, $18, 1, 0, 0, 0
		piece	-$10, 0, 2, 2, $18, 0, 1, 0, 0
		piece	0, 0, 2, 2, $18, 1, 1, 0, 0
		endsprite

Frame_DrownNum_Main:	spritemap
		piece	-8, -$C, 2, 3, $741, 1, 1, 0, 0
		endsprite
