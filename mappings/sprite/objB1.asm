Map_objB1:	mappingsTable offset(*)
...
Map_objB1_000A:	spriteHeader offset(*)
...
Map_objB1_003C:	spriteHeader offset(*)
...
Map_objB1_006E:	spriteHeader offset(*)
...
Map_objB1_00A0:	spriteHeader offset(*)
...
Map_objB1_00D2:	spriteHeader offset(*)
