; ---------------------------------------------------------------------------
; Sprite mappings - ring (placed in debug mode)
; ---------------------------------------------------------------------------

Map_Ring:	index offset(*)
	ptr	Map_obj37_a_0012
	ptr	Map_obj37_a_001C
	ptr	Map_obj37_a_0026
	ptr	Map_obj37_a_0030
	ptr	Map_obj37_a_003A
	ptr	Map_obj37_a_0044
	ptr	Map_obj37_a_004E
	ptr	Map_obj37_a_0058
	ptr	Map_obj37_a_0062
