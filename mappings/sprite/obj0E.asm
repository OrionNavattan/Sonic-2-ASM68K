Map_obj0E:	mappingsTable offset(*)
...
Map_obj0E_0028:	spriteHeader offset(*)
...
Map_obj0E_005A:	spriteHeader offset(*)
...
Map_obj0E_00A4:	spriteHeader offset(*)
...
Map_obj0E_00E6:	spriteHeader offset(*)
...
Map_obj0E_0150:	spriteHeader offset(*)
...
Map_obj0E_01BA:	spriteHeader offset(*)
...
Map_obj0E_0224:	spriteHeader offset(*)
...
Map_obj0E_028E:	spriteHeader offset(*)
...
Map_obj0E_0308:	spriteHeader offset(*)
...
Map_obj0E_03BE:	spriteHeader offset(*)
	spritePiece	-$50, 0, 4, 1, $283, 0, 0, 3, 1
	spritePiece	-$30, 0, 3, 1, $287, 0, 0, 3, 1
	spritePiece	$18, 0, 3, 1, $28A, 0, 0, 3, 1
	spritePiece	$30, 0, 4, 1, $28D, 0, 0, 3, 1
...
Map_obj0E_03F8:	spriteHeader offset(*)
	spritePiece	-4, -4, 1, 1, $291, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj0E_0402:	spriteHeader offset(*)
	spritePiece	-8, -8, 2, 2, $292, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj0E_040C:	spriteHeader offset(*)
	spritePiece	-$C, -$C, 3, 3, $296, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj0E_0416:	spriteHeader offset(*)
	spritePiece	-4, -4, 1, 1, $29F, 0, 0, 1, 0
	spriteFooter offset(*)

Map_obj0E_0420:	spriteHeader offset(*)
	spritePiece	-8, -4, 2, 1, $2A0, 0, 0, 0, 1
	spriteFooter offset(*)

Map_obj0E_042A:	spriteHeader offset(*)
...
Map_obj0E_044C:	spriteHeader offset(*)
	spritePiece	$28, 8, 4, 4, $226, 0, 0, 0, 1
	spritePiece	$20, $10, 1, 1, $236, 0, 0, 0, 1
	spritePiece	$18, $18, 2, 4, $237, 0, 0, 0, 1
	spritePiece	$48, 8, 2, 4, $23F, 0, 0, 0, 1
...
Map_obj0E_04BE:	spriteHeader offset(*)
