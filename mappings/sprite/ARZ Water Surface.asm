...
Map_obj04_b_0008:	spritemap
	piece	-$60, -4, 4, 2, 0, 0, 0, 0, 0
	piece	-$20, -4, 4, 2, 0, 0, 0, 0, 0
	piece	$20, -4, 4, 2, 0, 0, 0, 0, 0
	endsprite

Map_obj04_b_0022:	spritemap
	piece	-$60, -4, 4, 2, 8, 0, 0, 0, 0
	piece	-$20, -4, 4, 2, 8, 0, 0, 0, 0
	piece	$20, -4, 4, 2, 8, 0, 0, 0, 0
	endsprite

Map_obj04_b_003C:	spritemap
	piece	-$60, -4, 4, 2, 0, 0, 0, 0, 0
	piece	-$40, -4, 4, 2, 0, 0, 0, 0, 0
	piece	-$20, -4, 4, 2, 0, 0, 0, 0, 0
	piece	0, -4, 4, 2, 0, 0, 0, 0, 0
	piece	$20, -4, 4, 2, 0, 0, 0, 0, 0
	piece	$40, -4, 4, 2, 0, 0, 0, 0, 0
	endsprite
...
Map_obj04_b_006E:	spritemap
	piece	-$60, -4, 4, 2, 8, 0, 0, 0, 0
	piece	-$40, -4, 4, 2, 8, 0, 0, 0, 0
	piece	-$20, -4, 4, 2, 8, 0, 0, 0, 0
	piece	0, -4, 4, 2, 8, 0, 0, 0, 0
	piece	$20, -4, 4, 2, 8, 0, 0, 0, 0
	piece	$40, -4, 4, 2, 8, 0, 0, 0, 0
	endsprite
