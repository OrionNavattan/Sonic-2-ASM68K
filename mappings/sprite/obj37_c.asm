Map_obj37_c:	mappingsTable offset(*)
...
Map_obj37_c_0010:	spriteHeader offset(*)
	spritePiece	0, -$20, 4, 4, 0, 0, 0, 0, 0
	spritePiece	0, 0, 4, 4, 0, 0, 1, 0, 0
	spriteFooter offset(*)

Map_obj37_c_0022:	spriteHeader offset(*)
...
Map_obj37_c_0044:	spriteHeader offset(*)
...
Map_obj37_c_0066:	spriteHeader offset(*)
...
Map_obj37_c_0088:	spriteHeader offset(*)
...
Map_obj37_c_00AA:	spriteHeader offset(*)
...
Map_obj37_c_00CC:	spriteHeader offset(*)
	spritePiece	-$20, -$20, 4, 4, 0, 1, 0, 0, 0
	spritePiece	-$20, 0, 4, 4, 0, 1, 1, 0, 0
	spriteFooter offset(*)

Map_obj37_c_00DE:	spriteHeader offset(*)
