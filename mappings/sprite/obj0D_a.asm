Map_obj0D_a:	mappingsTable offset(*)
...
Map_obj0D_a_0048:	spriteHeader offset(*)
	spritePiece	-$18, -$10, 3, 4, 0, 0, 0, 0, 0
	spritePiece	0, -$10, 3, 4, 0, 1, 0, 0, 0
	spritePiece	-4, $10, 1, 2, $20, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj0D_a_0062:	spriteHeader offset(*)
	spritePiece	-$10, -$10, 4, 4, $C, 0, 0, 0, 0
	spritePiece	-4, $10, 1, 2, $20, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj0D_a_0074:	spriteHeader offset(*)
	spritePiece	-4, -$10, 1, 4, $1C, 0, 0, 0, 0
	spritePiece	-4, $10, 1, 2, $20, 0, 0, 0, 0
	spriteFooter offset(*)

Map_obj0D_a_0086:	spriteHeader offset(*)
