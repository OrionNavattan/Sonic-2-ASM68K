...
Frame_FloorSpiny_Move1:	spriteHeader
...
Frame_FloorSpiny_Move2:	spriteHeader
		spritePiece	-8, -$C, 1, 1, 0, 0, 0, 0, 0
...
Frame_FloorSpiny_Fire:	spriteHeader
...
Frame_WallSpiny_Move1:	spriteHeader
...
Frame_WallSpiny_Move2:	spriteHeader
...
Frame_WallSpiny_Fire:	spriteHeader
		spritePiece	-$C, -$18, 2, 3, $F, 0, 0, 0, 0
...
Frame_Spiny_Proj1:	spriteHeader
		spritePiece	-4, -4, 1, 1, $1E, 0, 0, 0, 0
		endsprite

Frame_Spiny_Proj2:	spriteHeader
